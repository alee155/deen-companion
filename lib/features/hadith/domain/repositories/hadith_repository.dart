...
abstract class HadithRepository {
  ...
  /// Synchronous read of whatever page 1 currently sits in the cache, if
  /// any — lets the reading list show instantly before the network call
  /// (if one is even needed) resolves.
  HadithPageResult? getCachedHadithPage(String collection, int page);
