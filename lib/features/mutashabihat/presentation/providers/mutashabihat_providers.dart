...
class MutashabihatInfoNotifier
    extends CacheFirstStreamNotifier<MutashabihatInfo> {
  @override
  MutashabihatInfo? readCache() =>
      ref.read(mutashabihatRepositoryProvider).getCachedInfo();

  @override
  Future<Result<MutashabihatInfo>> fetchFresh() =>
      ref.read(mutashabihatRepositoryProvider).fetchAndCacheInfo();
}
